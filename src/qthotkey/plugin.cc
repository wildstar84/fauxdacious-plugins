...
bool handle_keyevent(Event event)
{
    ...
    case Event::Forward:
    {
        aud_drct_seek(aud_drct_get_time() + aud_get_int("audacious", "step_size") * 1000);
        return true;
    }
    break;
    ...
    {
        aud_toggle_bool("audacious", "repeat");
        return true;
    }
    break;
    ...
    {
        aud_toggle_bool("audacious", "shuffle");
        return true;
    }
    break;
    ...
    {
        aud_toggle_bool("audacious", "stop_after_current_song");
        return true;
    }
    break;
