...
static const AudguiMenuItem main_items[] = {
    ...
    MenuSep (),
    MenuSub (N_("Playback"), "media-playback-start", get_menu_playback),
    MenuSub (N_("Playlist"), "audio-x-generic", get_menu_playlist),
    MenuSub (N_("Output"), nullptr, {output_items}),
    MenuSub (N_("View"), nullptr, get_menu_view),
    MenuSep (),
    MenuSub (N_("Services"), "media-optical", get_plugin_menu_main),
    MenuSep (),
...
static const AudguiMenuItem playback_items[] = {
    ...
    MenuToggle (N_("No Playlist Advance"), nullptr, 'n', CTRL, nullptr, "no_playlist_advance", view_redraw_main, "set no_playlist_advance"),
    MenuToggle (N_("Stop After This Song"), nullptr, 'm', CTRL, nullptr, "stop_after_current_song", view_redraw_main, "set stop_after_current_song"),
    MenuSep (),
