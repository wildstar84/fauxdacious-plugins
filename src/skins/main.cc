    ...
    switch (event->keyval)
    {
        ...
        */
        case GDK_KEY_Up:    /* JWT:ADDED FOR FAUXDACIOUS: */
            mainwin_set_volume_diff (volume_delta);
            return true;
        case GDK_KEY_Down:  /* JWT:ADDED FOR FAUXDACIOUS: */
            mainwin_set_volume_diff (-1 * volume_delta);
            return true;
    }
...
static void showhide_about_window_cb (Button * button, GdkEventButton * event)
{
...
static void mainwin_create_widgets ()
{
    ...
    /* JWT: mainwin_about->on_release ((ButtonCB) audgui_show_about_window); */
