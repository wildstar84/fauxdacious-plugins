...
static const audqt::MenuItem main_items[] = {
    ...
    audqt::MenuSep (),
    audqt::MenuSub ({N_("Playback"), "media-playback-start"}, get_menu_playback),
    audqt::MenuSub ({N_("Playlist"), "audio-x-generic"}, get_menu_playlist),
    audqt::MenuSub ({N_("Output")}, {output_items}),
    audqt::MenuSub ({N_("View")}, get_menu_view),
    audqt::MenuSep (),
    audqt::MenuSub ({N_("Services"), "media-optical"}, get_plugin_menu_main),
    audqt::MenuSep (),
...
static const audqt::MenuItem playback_items[] = {
    ...
    audqt::MenuToggle ({N_("No Playlist Advance"), nullptr, "Ctrl+N"}, {nullptr, "no_playlist_advance", "set no_playlist_advance"}, view_redraw_main),
    audqt::MenuToggle ({N_("Stop After This Song"), nullptr, "Ctrl+M"}, {nullptr, "stop_after_current_song", "set stop_after_current_song"}, view_redraw_main),
    audqt::MenuSep (),
